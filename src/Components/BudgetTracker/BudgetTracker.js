...
const BudgetTracker = () => {
  ...
  const renderPieChart = (budget) => {
    const data = [
      ...
      {
        name: "Over",
        value: budget.savings < 0 ? Math.abs(budget.savings) : 0,
      },
    ];
        ...
        <div className="summary-card">
          ...
          <div className="summary-item">
            ...
            <p
              className="amount"
              style={{
                color: totalBudget - totalSpent >= 0 ? "#339989" : "#ef4444",
              }}
            >
                ...
                <div className="budget-info">
                  ...
                  <div className="info-row">
                    ...
                    <span
                      className="value"
                      style={{
                        color: budget.savings >= 0 ? "#339989" : "#ef4444",
                      }}
                    >
                  ...
                  <div className="progress-bar">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor:
                          budget.spent > budget.amount ? "#ef4444" : "#339989",
                      }}
                    ></div>
                  </div>
                </div>
                <div className="visuals">{renderPieChart(budget)}</div>
              </div>
            </div>
          ))}
        </div>
