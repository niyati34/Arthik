...
const SignIn = () => {
  return (
    <div className="signin-signup-container" role="main" aria-label="Sign In / Sign Up">
      ...
      <div className="form-container">
        ...
        <form aria-label="Sign In or Sign Up form">
          ...
          <input id="username" name="username" type="text" placeholder="Username" aria-label="Username" required />
          <label htmlFor="password" className="visually-hidden">Password</label>
          <input id="password" name="password" type="password" placeholder="Password" aria-label="Password" required />
          <button type="submit" aria-label="Submit sign in or sign up form">Submit</button>
        </form>
      </div>
    </div>
  );
